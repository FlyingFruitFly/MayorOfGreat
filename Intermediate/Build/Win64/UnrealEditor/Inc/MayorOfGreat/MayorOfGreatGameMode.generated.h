...
class UUserWidget;
#ifdef MAYOROFGREAT_MayorOfGreatGameMode_generated_h
#error "MayorOfGreatGameMode.generated.h already included, missing '#pragma once' in MayorOfGreatGameMode.h"
#endif
...
public: \
	DECLARE_CLASS(AMayorOfGreatGameMode, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/MayorOfGreat"), MAYOROFGREAT_API) \
...
#define MayorOfGreat_Source_MayorOfGreat_MayorOfGreatGameMode_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(MAYOROFGREAT_API, AMayorOfGreatGameMode); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AMayorOfGreatGameMode); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	MAYOROFGREAT_API AMayorOfGreatGameMode(AMayorOfGreatGameMode&&); \
	MAYOROFGREAT_API AMayorOfGreatGameMode(const AMayorOfGreatGameMode&); \
public:
...
template<> MAYOROFGREAT_API UClass* StaticClass<class AMayorOfGreatGameMode>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID MayorOfGreat_Source_MayorOfGreat_MayorOfGreatGameMode_h
